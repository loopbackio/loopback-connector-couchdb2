...
Thank you for your interest in `loopback-connector-couchdb2`, an open source project
administered by IBM.

Contributing to `loopback-connector-couchdb2` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-connector-couchdb2)
