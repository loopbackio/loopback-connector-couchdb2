...
/**
 * A model index's naming convertion: '_design/LBModel__Foo__LBIndex__foo_index',
 * this function returns the model prefix, default as 'LBModel'.
 * 
 * TBD: Do we allow customized prefix? same question for 
 * `getIndexPropertyPrefix`, allow the flexibility would cause 
 * potential race condition, e.g. two models have same index's 
 * ddoc name
 */
...
CouchDB.prototype.defaultModelView = function(){
  const DEFAULT_MODEL_PREFIX = 'loopback__model__name';
  return DEFAULT_MODEL_PREFIX;
}
 ...
 * Default as 'LBIndex'
 */
CouchDB.prototype.getIndexPropertyPrefix = function(model) {
